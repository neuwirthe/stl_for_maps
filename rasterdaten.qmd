...
all_raster_exist <-
  ...
  file_exists(path(here(),"raster_data", "gelaende", "niederoesterreich","oest_raster_10m_31256.tif"))  &&
  file_exists(path(here(),"raster_data", "gelaende", "niederoesterreich","oest_raster_10m_4326.tif"))   
```
...
https://open-data.noe.gv.at/ogd-data/BD1/DTM_10x10.zip

```{r}
curl_download(
  "https://open-data.noe.gv.at/ogd-data/BD1/DTM_10x10.zip",
  path(here(), "raster_data", "gelaende", "niederoesterreich","DTM_10x10.zip"),
  quiet=FALSE
)
```
...
```{r}
if(!all_raster_exist){
unzip(path(here(), "raster_data", "gelaende", "niederoesterreich","DTM_10x10.zip"),
      exdir=path(here(), "raster_data", "gelaende", "niederoesterreich","DTM_10x10")
)
}
noe_raster <-
  rast(path(here(), "raster_data", "gelaende", "niederoesterreich","DTM_10x10",
            "DTM_10x10.tif"))
...
```{r}
if(!all_raster_exist){
project(noe_raster,"EPSG:4326") ->
  noe_raster_4326
writeRaster(noe_raster_4326,
            path(here(), "raster_data", "gelaende", "niederoesterreich",
                 "noe_raster_10m_4326.tif"),
            overwrite=TRUE
)
}
```
...
```{r}
if(!all_raster_exist){
project(noe_raster,"EPSG:31256") ->
  noe_raster_31256
writeRaster(noe_raster_31256,
            path(here(), "raster_data", "gelaende", "niederoesterreich",
            overwrite=TRUE
                 "noe_raster_10m_31256.tif"),
)
}
```
...
curl_download(
"https://data.bev.gv.at/download/ALS/DTM/20240915/ALS_DTM_CRS3035RES50000mN2800000E4800000.tif",
  path(here(), "raster_data", "oberflaeche", "oesterreich", "ALS_DTM_1m",
...
Ich hole mit wget diese Dateien

https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4800000.tif
https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4800000.tif
https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4800000.tif
https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4800000.tif


und verschiebe sie nach raster_data/oberflaeche/oesterreich

Die Variante in nächsten codeblock
...
"https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4800000.tif",
  path(here(), "raster_data", "oberflaeche", "oesterreich",
       "ALS_DSM_CRS3035RES50000mN2800000E4800000.tif"),
  quiet=FALSE
)
toc()
tic()
curl_download(
"https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2800000E4750000.tif",
  path(here(), "raster_data", "oberflaeche", "oesterreich",
       "ALS_DSM_CRS3035RES50000mN2800000E4750000.tif"),
  quiet=FALSE
)
curl_download(
"https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2750000E4800000.tif",
  path(here(), "raster_data", "oberflaeche", "oesterreich",
       "ALS_DSM_CRS3035RES50000mN2750000E4800000.tif"),
  quiet=FALSE
)
toc()
tic()
curl_download(
"https://data.bev.gv.at/download/ALS/DSM/20240915/ALS_DSM_CRS3035RES50000mN2750000E4750000.tif",
  path(here(), "raster_data", "oberflaeche", "oesterreich",
